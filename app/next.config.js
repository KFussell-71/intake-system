...
const withPWA = withPWAInit({
    dest: 'public',
    disable: false, // Enabled for packaging verification on local dev
    register: true,
    skipWaiting: true,
    reloadOnOnline: true,
    runtimeCaching: [
        ...
        return [
            {
                ...
                headers: [
                    ...
                    },
                    {
                        ...
                        value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; img-src 'self' blob: data:; font-src 'self' https://cdn.jsdelivr.net; connect-src 'self' https://*.supabase.co https://*.googleapis.com http://127.0.0.1:54321 http://localhost:54321 ws: wss:;",
                    }
                ],
            },
        ];
