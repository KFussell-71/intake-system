...
export function GettingStartedWidget() {
    ...
    return (
        <Card className="bg-linear-to-r from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-800 border-blue-200 dark:border-blue-900 p-6 relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-start relative z-10">
                ...
                <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                    {items.map(item => (
                        ...
                        >
                            <div
                                className={`mt-1 shrink-0 cursor-pointer transition-colors ${item.completed ? 'text-blue-600' : 'text-slate-300 hover:text-blue-400'}`}
