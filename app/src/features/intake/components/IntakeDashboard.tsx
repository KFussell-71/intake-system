        ...
        <div className="space-y-6 animate-in fade-in max-w-5xl mx-auto">
            ...
            <div className="flex justify-between items-center mt-8 border-t pt-6 border-slate-200 dark:border-slate-800">
                ...
                <div className="flex gap-3">
                    <button className="border-slate-200 dark:border-slate-800 hover:bg-slate-50 rounded-md px-4 py-2 text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50">
                        Smart Save (Draft)
                    </button>
                    <Button
                        disabled={visibleSections.some(s => getStatus(s.id) !== 'complete')}
                        onClick={() => onNavigate('review')}
                        className="bg-linear-to-r from-emerald-600 to-teal-600 hover:shadow-xl transition-all"
                    >
                        Finalize & Submit
                    </Button>
                </div>
