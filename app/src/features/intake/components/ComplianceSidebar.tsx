...
import { suggestRSA911Codes } from '@/app/(app)/actions/ai/rsa911Actions';
...
export const ComplianceSidebar: React.FC<Props> = ({ formData, intakeId }) => {
    ...
    return (
        <div className="w-80 h-fit sticky top-32 space-y-6">
            {/* AI Assistant Card */}
            <div className="p-4 rounded-3xl bg-linear-to-br from-indigo-600 to-violet-600 text-white shadow-xl shadow-indigo-500/30">
            ...
            <div className="p-6 rounded-3xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700">
                ...
                <DORReportButton intakeId={intakeId || "current_session"} clientName={formData.clientName || "Current Client"} />
            </div>
        </div>
    );
};
