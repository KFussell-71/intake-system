    ...
    return (
        <div className="mt-8">
            ...
            <button
                ...
                disabled={loading}
                className="w-full p-4 bg-linear-to-r from-indigo-500 to-purple-600 rounded-2xl text-white font-bold flex items-center justify-center gap-2 hover:shadow-xl hover:shadow-indigo-500/20 transition-all disabled:opacity-50"
            >
                        ...
                        {suggestions.map((s, idx) => (
                            ...
                            >
                                <div className="flex gap-4">
                                    <div className={`p-3 rounded-2xl shrink-0 ${s.category === 'career' ? 'bg-blue-500/10 text-blue-500' :
