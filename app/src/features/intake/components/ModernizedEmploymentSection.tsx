    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold bg-linear-to-r from-blue-600 to-indigo-500 bg-clip-text text-transparent">
            ...
            <div className="flex justify-end pt-4 gap-4">
                ...
                <button
                    ...
                    className="px-4 py-2 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-md hover:shadow-lg transition-all"
                >
                    Mark Complete
                </button>
            </div>
