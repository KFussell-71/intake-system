...
import { getPublicDashboardDataAction, publishPublicMetricsAction } from '@/app/(app)/actions/transparencyActions';
...
export const TransparencyDashboard = () => {
    ...
    return (
        <div className="space-y-6">
            <GlassCard className="bg-linear-to-r from-slate-900 to-slate-800 text-white border-none">
