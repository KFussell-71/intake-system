...
import { returnForRevisionAction } from '@/app/(app)/actions/intakeActions';
...
export const ReturnForRevisionDialog: React.FC<ReturnForRevisionDialogProps> = ({
    ...
    const handleReturn = async () => {
        ...
        try {
            const result = await returnForRevisionAction(intakeId, reason, notes, urgent);

            if (!result.success) {
                throw new Error(result.error || 'Failed to return report');
            }
