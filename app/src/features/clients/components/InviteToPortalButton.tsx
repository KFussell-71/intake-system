...
import { inviteClientToPortal } from '@/app/(app)/actions/portal/inviteClientToPortal';
import { revokeClientPortalAccess } from '@/app/(app)/actions/portal/revokeClientPortalAccess';
        ...
        <>
            <button
                ...
                className={iconOnly
                    ...
                    : "inline-flex items-center gap-2 px-4 py-2 bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white text-sm font-medium rounded-lg transition-all shadow-lg shadow-emerald-500/20"
                }
                        ...
                        <form onSubmit={handleInvite} className="space-y-4">
                            ...
                            <div className="flex gap-3">
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="flex-1 py-2 bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 disabled:from-slate-600 disabled:to-slate-700 text-white font-medium rounded-lg transition-all"
                                >
