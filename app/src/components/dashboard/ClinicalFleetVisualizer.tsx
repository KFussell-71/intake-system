                        ...
                        {fleet.map((member) => (
                            ...
                            >
                                <GlassCard className="relative overflow-hidden group hover:border-primary/50 transition-colors">
                                    ...
                                    <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-linear-to-r from-primary/5 via-primary to-primary/5 opacity-50 overflow-hidden">
                                        <motion.div
                                            animate={{ x: [-100, 400] }}
