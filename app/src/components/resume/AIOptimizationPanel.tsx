...
import { generateSummaryAction, optimizeForATSAction } from '@/app/(app)/actions/aiEmploymentActions';
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-3">
                    <button
                        ...
                        disabled={loading}
                        className="w-full px-4 py-3 bg-linear-to-r from-purple-600 to-indigo-600 text-white rounded-lg font-medium hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                        {loading ? (
                            <>
                ...
                <div className="space-y-3">
                    <button
                        ...
                        disabled={loading}
                        className="w-full px-4 py-3 bg-linear-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-medium hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                        {loading ? (
                            <>
                                <Loader2 className="w-5 h-5 animate-spin" />
