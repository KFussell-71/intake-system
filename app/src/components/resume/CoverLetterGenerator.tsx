...
import { generateCoverLetterAction } from '@/app/(app)/actions/aiEmploymentActions';
        ...
        <GlassCard className="p-6">
            <div className="space-y-6">
                ...
                <button
                    ...
                    className="w-full px-4 py-3 bg-linear-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-medium hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                >
                    {loading ? (
                        <>
