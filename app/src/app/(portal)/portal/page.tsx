...
import { getPortalMessagesAction, sendPortalMessageAction } from '@/app/(app)/actions/portal/messageActions';
...
export default async function PortalHome() {
    ...
    return (
        <div className="space-y-8">
            {/* Welcome Header */}
            <div className="bg-linear-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 rounded-2xl p-6">
