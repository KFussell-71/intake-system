            ...
            <div className="bg-slate-800/50 border border-white/10 rounded-2xl p-6">
                ...
                <div className="space-y-6">
                    ...
                    <button
                        ...
                        className="w-full py-3 px-4 bg-linear-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 disabled:from-slate-600 disabled:to-slate-700 disabled:cursor-not-allowed text-white font-medium rounded-xl transition-all shadow-lg shadow-emerald-500/20 disabled:shadow-none"
                    >
                        {uploading ? (
