...
const ActivityFeed = dynamic(() => import('@/components/dashboard/ActivityFeed').then(mod => mod.ActivityFeed), {
    loading: () => <div className="space-y-4 pt-4"><div className="h-10 animate-pulse bg-slate-100 dark:bg-white/5 rounded-lg" /><div className="h-10 animate-pulse bg-slate-100 dark:bg-white/5 rounded-lg" /></div>
});
const StaffingForecastWidget = dynamic(() => import('@/features/dashboard/components/StaffingForecastWidget').then(mod => mod.StaffingForecastWidget), {
    loading: () => <div className="h-full animate-pulse bg-slate-100 dark:bg-white/5 rounded-xl" />
});
...
export default function DashboardPage() {
    ...
    return (
        <div className="min-h-screen bg-surface dark:bg-surface-dark selection:bg-accent/30 selection:text-accent relative overflow-hidden">
            {/* Pro Max Aesthetic Mesh */}
            <div className="absolute inset-0 -z-10 bg-[radial-gradient(ellipse_at_top_left,rgba(59,130,246,0.1),transparent_50%),radial-gradient(ellipse_at_bottom_right,rgba(168,85,247,0.1),transparent_50%)]" />
            <motion.div
                animate={{
                    scale: [1, 1.1, 1],
                    opacity: [0.3, 0.5, 0.3],
                ...
                className="absolute top-1/4 -right-20 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[120px] -z-10"
            />
            <motion.div
                animate={{
                    scale: [1, 1.2, 1],
                ...
                className="absolute bottom-1/4 -left-20 w-[600px] h-[600px] bg-accent/5 rounded-full blur-[150px] -z-10"
            />
