...
import { getResources, createResource, updateResource, deleteResource, AVResource } from "@/app/(app)/actions/resourceActions";
                            ...
                            <GlassCard key={resource.id} className="p-4 flex justify-between items-start group hover:shadow-md transition">
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 flex items-center gap-2">
                                        ...
                                        {resource.phone && <span>ðŸ“ž {resource.phone}</span>}
                                    </p>
