...
import { getAwaitingReviewReportsAction } from '@/app/(app)/actions/intakeActions';
...
import { approveReportAction, returnForRevisionAction } from '@/app/(app)/actions/intakeActions';
...
export default function ReviewQueuePage() {
    ...
    const fetchReports = async () => {
        setLoading(true);
        try {
            const result = await getAwaitingReviewReportsAction();
    ...
    const handleApprove = async (reportId: string) => {
        const result = await approveReportAction(reportId, 'Report approved from review queue');
        if (result.success) {
            fetchReports();
        }
    };
