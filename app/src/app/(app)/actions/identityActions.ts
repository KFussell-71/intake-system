...
export async function saveIdentityAction(intakeId: string, data: Partial<IdentityData>) {
    ...
    try {
        ...
        try {
            ...
            console.log('intake_identity missing, skipping relational fetch');
        }
        ...
        try {
            ...
            if (relError) console.warn(`Relational Write Failed: ${relError.message}`);
        } catch (e) {
            console.warn('intake_identity table missing, skipping relational write');
        }
