        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="bg-slate-800/50 border border-white/10 rounded-xl p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            {/* Milestones with completion_date are considered achieved */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link
                    ...
                    className="group bg-slate-800/50 border border-white/10 rounded-xl p-6 hover:bg-slate-700/50 hover:border-emerald-500/30 transition-all"
                >
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-400">
                                Submit requested documents securely
                            </p>
                        </div>
                    </div>
                </Link>
                ...
                <Link
                    href="/portal/status"
                    className="group bg-slate-800/50 border border-white/10 rounded-xl p-6 hover:bg-slate-700/50 hover:border-blue-500/30 transition-all"
                >
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-blue-500/20 group-hover:bg-blue-500/30 flex items-center justify-center transition-colors">
                ...
                <div className="bg-slate-800/50 border border-white/10 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                        {milestones.slice(0, 5).map((milestone: any) => (
                            ...
                            >
                                {/* Milestone is achieved if it has a completion_date */}
                                ...
                                <div className="flex-1">
                                    <p className="text-sm text-white">{milestone.milestone_name}</p>
            ...
            <div className="bg-slate-800/30 border border-white/5 rounded-xl p-4 text-center">
                <p className="text-xs text-slate-500">
                    Portal access expires: {new Date(accessInfo.expiresAt).toLocaleDateString()}
                </p>
            </div>
        </div>
    );
