...
import { ShieldAlert, Activity, FileWarning, Users, Target, LogOut } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2 text-sm bg-slate-100 dark:bg-slate-800 px-3 py-1 rounded-full">
